...
ARGUMENTS = {
    ...
    "validation-prop":       { "default": Hyperparams.validation_prop,    "type": float, "help": "How much of the data to reserve for validation" },
    ...
    "post-command":          { "default": "", "help": "Format: <x>h<y>:::<command> for exiting and running command after x hours and y minutes. E.g. 23h30:::sudo rm -rf /" },
